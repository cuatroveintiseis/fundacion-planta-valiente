const translations = {
    es: {
        ...
        "counter.beach": "Kilos de aceite recolectados",
        ...
        "carousel.p.proyecto1": "Fundación Planta Valiente lidera una campaña de recolección de aceites de cocina usados en alianza con la cooperativa ConCon Recicla, iniciativa que se desarrolla principalmente en establecimientos educacionales interesados en fortalecer sus acciones de educación ambiental y participación ciudadana. A través de esta campaña, los establecimientos que deseen incorporarse pueden ponerse en contacto con nuestra fundación para conocer el proceso de implementación, sus beneficios y las distintas acciones de sensibilización asociadas. Esta iniciativa contribuye al fortalecimiento del Plan de Formación Ciudadana establecido en la Ley 20.911, promoviendo una comunidad educativa más consciente, participativa y comprometida con el cuidado del medio ambiente. Para más información sobre cómo sumarse a esta campaña, invitamos a contactarnos a través de nuestras redes sociales y plataformas oficiales.",
        ...
        "news.title.1": "Aventureros Austerra",
        "news.1": "Una red de fotógrafos, exploradores y creadores de contenido que recorren Chile y el mundo, y que apoyan a Austerra Society con sus historias, imágenes y mirada propia sobre la naturaleza.",
